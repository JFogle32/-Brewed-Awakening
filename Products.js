...
document.addEventListener(
    ...
    (clickEvent) => {
        ...
        */
        ...
        /*
            Only run the rest of the logic if a product <li> was clicked
        */
        if (itemClicked.id.startsWith("product")) {
            ...
            /*
                ...
                attribute ("product--2" if you clicked on the second one).
            ...
            */
            for (const singleProduct of products) {
                ...
                */
                ...
                if (parseInt(productPrimaryKey) === singleProduct.id) {
                    matchingProduct = singleProduct
                }
            }
        
            //Find related price assigned to the product.
